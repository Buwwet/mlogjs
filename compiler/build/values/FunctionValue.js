...
class FunctionValue extends VoidValue_1.VoidValue {
    ...
    typeof(scope) {
        return [new LiteralValue_1.LiteralValue(scope, "function"), []];
    }
    createInst() {
        this.inst = [
            new instructions_1.AddressResolver(this.addr),
    ...
    inlineReturn(scope, arg) {
        ...
        return [null, [...argInst, new instructions_1.ReturnInstruction(this.inlineEnd)]];
    }
