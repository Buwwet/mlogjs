...
class BaseValue extends _1.VoidValue {
    "u-"(scope) {
        ...
        return [
            ...
            [
                ...inst,
                new instructions_1.OperationInstruction("sub", temp, new _1.LiteralValue(scope, 0), that),
            ],
        ];
    }
}
    ...
    BaseValue.prototype[key] = function (scope, value) {
        ...
        return [
            ...
            [
                ...leftInst,
                ...rightInst,
                new instructions_1.OperationInstruction(kind, temp, left, right),
            ],
        ];
    };
}
...
for (const key in unaryOperatorMap) {
    ...
    BaseValue.prototype[key] = function (scope) {
        const [that, inst] = this.eval(scope);
        const temp = new _1.TempValue(scope);
        return [temp, [...inst, new instructions_1.OperationInstruction(name, temp, that, null)]];
    };
}
...
for (const key of operators_1.updateOperators) {
    BaseValue.prototype[key] = function (scope, prefix) {
        ...
        return [
            ret,
            [...inst, ...this[kind](scope, new _1.LiteralValue(scope, 1))[1]],
        ];
    };
}
