...
const ArrowFunctionExpression = (c, scope, node) => {
    const name = (0, utils_1.nodeName)(node);
    ...
    for (const id of params) {
        ...
        paramStores.push(scope.make(id.name, (0, utils_1.nodeName)(id)));
    }
    return [
...
const FunctionDeclaration = (c, scope, node) => {
    return [
        scope.set(node.id.name, (0, exports.ArrowFunctionExpression)(c, scope, node, null)[0]),
        [],
    ];
};
